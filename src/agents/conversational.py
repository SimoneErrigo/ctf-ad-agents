...
CONVERSATIONAL_SYSTEM_PROMPT = (
    ...
    "(b) create Janus alert/drop rules, and (c) patch vulnerable services at "
    "the source level and deploy the fix to the competition VM.\n\n"
    ...
    "creation, source-level patching, rollback) and returns a written report. "
    ...
    "a vulnerability, or rolling back a deploy.\n\n"
